      ...
      <section className="px-6 pb-5">
        <div className="max-w-2xl mx-auto text-center space-y-2">
          ...
          <p className="leading-relaxed" style={{ color: "#D8E2DC" }}>
            חולצות ומכנסיים שעוצבו במיוחד בשביל הקהילה שלנו — נוחות על האופניים ונראות מעולה גם אחרי הרכיבה. הזמינו עכשיו
            במחיר הזמנה מוקדמת ותהיו הראשונים לרכוב איתם.
          </p>
        </div>
      </section>
