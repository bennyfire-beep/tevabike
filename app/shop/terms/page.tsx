...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "בהתאם לחוק הגנת הצרכן, ניתן לבטל עסקה תוך 14 יום מקבלת המוצר. החלפות והחזרות מתבצעות בתיאום מראש מול מחסני הספק בלבד, בטלפון 0509446696, בשעות הפעילות: א'–ה' 08:00–16:00 (בימי שישי ושבת אין מענה). ביטול שלא עקב פגם עשוי לחייב דמי ביטול בשיעור של עד 5% ממחיר המוצר או 100 ₪, לפי הנמוך.",
  },
  {
    title: "7. פרטיות",
